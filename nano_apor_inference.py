...
if __name__ == "__main__":
    # nohup python edge_tapor_inference2.py -wp "24_202436211552_tm2.pth" -fs 1 -fd 336 -ld 48 -bs 128 -dd 0 -v 1 >> EdgeTapor_files/edgeTapor_logs/48.log 2>&1 &
    ...
    log_folder = "EdgeTapor_files/edgeTapor_inference_logs/"
    if not os.path.exists("EdgeTapor_files/edgeTapor_inference_logs"):
        os.makedirs("EdgeTapor_files/edgeTapor_inference_logs")
